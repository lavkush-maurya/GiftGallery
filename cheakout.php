  ...
  <div class="navd1" style="width:100%;">
        ...
        <ul class="navul2" style="padding-left: 5%;">
          <div style="display: inline-flex;">
            ...
            <li class="navli1" style="margin-top: -6px;">
              <a href="ulogout.php" class="b1" style="border: 1px solid silver;"> LOGOUT</a>
            </li>
          </div>
        </ul>
  </div>
                                    ...
                                    ?>
                                      ...
                                      <table class="table">
                                          ...
                                          <?php
                                                ...
                                                $q2="select * from product where id = '$pf'";
                                                  ...
                                                  $pname = $d2['name'];  
                                                      ...
                                                      echo "
                                                          ...
                                                          <tr>
                                                              ...
                                                              <td><input type='number' readonly id='fnum' value='$price' style='visibility:hidden;height :0px;width:0px;margin:0px;position: absolute;'><p>".$d2['price'].".00<span style='color: green;font-weight: 600;'>₹</span></p></td>";?>
                                          ...
                                          ?>
                                            ...
                                            <input type="number" name="sui" value="<?php echo"$ty"; ?>" id="result2">
