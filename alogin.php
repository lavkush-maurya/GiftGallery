...
<?php
    ...
    $pass=$_GET['password'];
      ...
      if(isset($_GET['submit']))
      {
        ...
        $q2="select * from alogin where email='$mail'";
               ...
               while($data=mysqli_fetch_array($r))
                      {
                          ...
                          {
                            echo "<script> alert('welcome ".$data['name']."');window.location.assign('adash.php');</script>";
                           
                          }
                          else{
                            echo "<script> alert('invalid username or password');window.location.assign('alogin.php');</script>";
                          }
                      }
